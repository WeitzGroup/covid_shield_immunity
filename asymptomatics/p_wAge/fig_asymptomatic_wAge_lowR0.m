...
% figure is drawn
tmpfilename = 'fig_asymptomatic_pWage_lowR0cst';
...
title({'Asymptomatic fraction $p$ as a function of age';' Low scenario ${\cal{R}}_0=1.56$'},'fontsize',18,'interpreter','latex')
ylim([0 20]);
xlim([0 365])
legend([legB,leg,legH],{'Baseline','2:1 Shielding','20:1 Shielding'});
legend('boxoff');
text(150,8,'\it{p} = 0.5','FontSize',16,'Color',[0.1 0.1 0.1])
text(160,5,'\it{p} = 0.75','FontSize',16,'Color',[0.5 0.5 0.5])
text(200,2.5,'\it{p} = 0.9','FontSize',16,'Color',[0.75 0.75 0.75])
...
legend([legB,leg,legH],{'Baseline','2:1 Shielding','20:1 Shielding'});
legend('boxoff');
text(150,450,'\it{p} = 0.5','FontSize',16,'Color',[7, 47, 95]/255)
text(160,250,'\it{p} = 0.75','FontSize',16,'Color',[56, 149, 211]/255)
text(200,150,'\it{p} = 0.9','FontSize',16,'Color',[88, 204, 237]/255)
