...
% figure is drawn
tmpfilename = 'fig_asymptomatic_pcst_R0dynamic';
...
title({'Asymptomatic fraction $p$ constant with age';'${\cal{R}}_0$ as a function of $p$'},'fontsize',18,'interpreter','latex','color','k')
xlim([0.5 0.95])
ylim([0 600])
