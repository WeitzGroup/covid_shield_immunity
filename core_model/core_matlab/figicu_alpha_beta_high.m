...
% figure is drawn
tmpfilename = 'figicu_alpha_beta_high';
...
clabel(c,h)
[c,h]=contour(pars.alpha_range,pars.sdistance,stats.Hacu_max*10^5,[1 2 5 10 15 20 30 40 60 100 150]);
...
title({'Peak ICU beds needed, per 100,000';'High Scenario, ${\cal{R}}_0=2.33$'},'fontsize',18,'interpreter','latex')
