...
title({'COVID-19 Epidemic - Low Scenario - Shields Ages 20-60';'${\cal{R}}_0=1.57$, Mean immunity duration: 2 months'},'fontsize',18,'interpreter','latex');
...
axes(tmpax(2));
ylabel('Population age structure','fontsize',16,'verticalalignment','top','fontweight','bold','color', 'k', 'interpreter', 'latex');
set(gca,'ycolor',[0.25 0.25 0.25]);
ylim([0 0.2]);

set(gcf, 'position', [349    76   726   7295]);
saveas(gcf, './Fig_immune_2m_low', 'fig')
saveas(gcf, './Fig_immune_2m_low','epsc')
