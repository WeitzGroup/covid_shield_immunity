...
% figure is drawn
tmpfilename = 'figbaseline_shields_target_low';
...
pars.Rshields_deploy = (load('ga_shields_delpoyment_alpha2_lowCase.txt'))';
...
pars.Rshields_deploy = (load('ga_shields_delpoyment_alpha20_lowCase.txt'))';
